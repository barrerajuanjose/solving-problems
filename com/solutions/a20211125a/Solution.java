package com.solutions.a20211125a;
...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        List<Integer> s = Stream.of("278 576 496 727 410 124 338 149 209 702 282 718 771 575 436".replaceAll("\\s+$", "").split(" ")).map(Integer::parseInt)
                .collect(toList());
